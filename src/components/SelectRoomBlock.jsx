...
class SelectRoomBlock extends React.Component{
    ...
    render(){
        ...
        return(
            <div onClick={this.props.RoomClick!==null?()=>this.props.RoomClick(this.props.id, this.props.indexRoom):()=>{}} style={this.props.selectId===-1?{}:selectedRoomStyle} className="select-room_roomblock">
                ...
                <img onClick={()=>this.props.closeClick()} style={this.props.selectId===-1?{}:{display:'block'}} className = "selct-room_icon"  src="assets/close.svg" alt=""/>
            </div>
        )
    }
}
